...
- json-schema-to-typescript 16.0.0：npm artifact gitHead `7f72770eb854328c96b112be445da0306bebdbaf`；读取发布包 dist/src/index.js 的 compile 管线。TS 只生成类型，结构校验由 Ajv 8.20.0 承担。版本及完整性由 pnpm-lock 持有。
