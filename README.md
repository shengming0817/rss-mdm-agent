...
当前包含独立自助目录核心、执行/AI 会话契约、交互/能力/授权纯核心、Vue UI 包与 Tauri 桌面基础壳，提供无真实执行的固定样本；尚无后台服务或正式安装包。本批 C01–C20 的目标是独立核心、从 prmonitor 提取 AI/UI 和测试执行器闭环；真实平台命令、软件安装、提权、远程管理与 T3 留后续交付。
