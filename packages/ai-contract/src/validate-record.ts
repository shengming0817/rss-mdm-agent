  ...
  if (errors === 0) {
    if (data && typeof data == "object" && !Array.isArray(data)) {
      ...
      if (
        ...
        const _errs1 = errors;
        for (const key0 in data) {
          if (!func22.call(schema84.properties, key0)) {
            validate43.errors = [
              {
                instancePath,
                schemaPath: "#/additionalProperties",
                        ...
                        if (valid16) {
                          if (data.status !== undefined) {
                            ...
                            if (
                              ...
                              const err80 = {
                                instancePath: instancePath + "/status",
                                schemaPath: "#/oneOf/7/properties/status/enum",
                                keyword: "enum",
                                params: {
                                  allowedValues:
                                    schema74.oneOf[7].properties.status.enum,
                                },
                                message:
                                  "must be equal to one of the allowed values",
                              };
                ...
                if (errors === _errs84) {
                  if (data && typeof data == "object" && !Array.isArray(data)) {
                    ...
                    if (
                      ...
                      (data.failure === undefined && (missing8 = "failure"))
                    ) {
                      const err82 = {
                        instancePath,
                  ...
                  if (errors === _errs90) {
                    if (
                      ...
                      if (
                        ...
                        (data.surface === undefined && (missing9 = "surface"))
                      ) {
                        const err87 = {
                          instancePath,
  ...
  if (errors === 0) {
    if (data && typeof data == "object" && !Array.isArray(data)) {
      ...
      if (
        ...
        const _errs1 = errors;
        for (const key0 in data) {
          if (!func22.call(schema110.properties, key0)) {
            validate54.errors = [
              {
                instancePath,
                schemaPath: "#/additionalProperties",
              ...
              validate54.errors = [
                {
                  ...
                  keyword: "enum",
                  params: {
                    allowedValues: schema110.properties.continuation.enum,
                  },
                  message: "must be equal to one of the allowed values",
                },
              ];
                ...
                validate54.errors = [
                  {
                    ...
                    keyword: "enum",
                    params: {
                      allowedValues: schema110.properties.cancellation.enum,
                    },
                    message: "must be equal to one of the allowed values",
                  },
                ];
                  ...
                  validate54.errors = [
                    {
                      ...
                      keyword: "enum",
                      params: {
                        allowedValues: schema110.properties.tools.enum,
                      },
                      message: "must be equal to one of the allowed values",
                    },
                  ];
                            ...
                            validate48.errors = [
                              {
                                ...
                                params: {
                                  allowedValues:
                                    schema95.properties.status.enum,
                                },
                                message:
                                  "must be equal to one of the allowed values",
                              },
  ...
  if (errors === 0) {
    if (data && typeof data == "object" && !Array.isArray(data)) {
      ...
      if (
        ...
        const _errs1 = errors;
        for (const key0 in data) {
          if (!func22.call(schema118.properties, key0)) {
            validate57.errors = [
              {
                instancePath,
                schemaPath: "#/additionalProperties",
                              ...
                              validate57.errors = [
                                {
                                  ...
                                  params: {
                                    allowedValues:
                                      schema118.properties.status.enum,
                                  },
                                  message:
                                    "must be equal to one of the allowed values",
                                },
                                  ...
                                  validate57.errors = [
                                    {
                                      ...
                                      schemaPath:
                                        "#/properties/callbackLifetime/type",
                                      keyword: "type",
                                      params: { type: "string" },
                                      message: "must be string",
                                    },
                                  ...
                                  validate57.errors = [
                                    {
                                      instancePath:
                                        instancePath + "/callbackLifetime",
                                      schemaPath:
                                        "#/properties/callbackLifetime/enum",
                                      keyword: "enum",
                                      params: {
                                        allowedValues:
                                          schema118.properties.callbackLifetime
                                            .enum,
                                      },
                                      message:
                                        "must be equal to one of the allowed values",
  ...
  if (errors === 0) {
    if (data && typeof data == "object" && !Array.isArray(data)) {
      ...
      if (
        ...
        const _errs1 = errors;
        for (const key0 in data) {
          if (!func22.call(schema127.properties, key0)) {
            validate60.errors = [
              {
                instancePath,
                schemaPath: "#/additionalProperties",
                            ...
                            validate60.errors = [
                              {
                                ...
                                params: {
                                  allowedValues:
                                    schema127.properties.retry.enum,
                                },
                                message:
                                  "must be equal to one of the allowed values",
                              },
  ...
  if (errors === 0) {
    if (data && typeof data == "object" && !Array.isArray(data)) {
      ...
      if (
        ...
        const _errs1 = errors;
        for (const key0 in data) {
          if (!func22.call(schema133.properties, key0)) {
            validate64.errors = [
              {
                instancePath,
                schemaPath: "#/additionalProperties",
  ...
  if (errors === 0) {
    if (data && typeof data == "object" && !Array.isArray(data)) {
      ...
      if (
        ...
        const _errs1 = errors;
        for (const key0 in data) {
          if (!func22.call(schema141.properties, key0)) {
            validate66.errors = [
              {
                instancePath,
                schemaPath: "#/additionalProperties",
