...
const statements = [
  ...
  `CREATE TABLE connections (tenant_id TEXT NOT NULL, principal_id TEXT NOT NULL, authority_id TEXT NOT NULL, id TEXT NOT NULL, revision INTEGER NOT NULL, ${row}, PRIMARY KEY (tenant_id,principal_id,authority_id,id,revision)) STRICT, WITHOUT ROWID`,
